			...
			<div className="about-info">
				<div className="about-text">
					<div className="aboutme">
						<p>Hi, I'm <span>Vladimir Luna Santos</span> from Colombia  <i className="far fa-smile"></i></p>
						<p>I'm a Computer Science Engineer / Software Developer.</p>
						<p>I consider myself a natural born logical thinker and I love to face new programming challenges!</p>
					</div>
			...
			<div className="about-social">
				<div className="about-contact">
					...
					<div className="contact-links">
						<h6><i className="fas fa-phone-square-alt"></i>+57 314 2997313</h6>
						<h6><i className="fas fa-envelope"></i>vladlunasan@gmail.com</h6>
						<h6><i className="fab fa-discord"></i>vlunasan#3650</h6>
					</div>
				</div>
